    ...
    <div className="pt-20">
      ...
      <div className="container mx-auto flex flex-wrap justify-between gap-20 pt-16">
        <div className="w-full px-4 pb-10 text-azul-900 md:w-[60%]">
          <h1 className="font-yanone text-[3.8rem] md:text-[4rem]">
            Bem-Vindo!
          </h1>
          <div className="flex flex-col gap-5 font-nunito text-[1.5rem] md:text-[2rem]">
            <p>
      ...
      <div className="relative">
        <div className="absolute top-0 flex h-auto w-full flex-col bg-contain bg-right bg-no-repeat px-4 pr-8 pt-16 md:h-[50rem] md:flex-row md:justify-end md:bg-vetor1 md:pt-56">
          <div className="flex w-full flex-col items-center md:w-[46.25rem] md:items-start">
            ...
            <button className="mt-6 w-[18.75rem] rounded-xl border-2 border-azul-900 p-2 font-yanone text-lg font-medium text-azul-900 md:ml-44 md:p-3 md:text-[2.1875rem]">
              Faça o quiz!
            </button>
          </div>
        </div>
        ...
        <div className="absolute top-[28rem] flex h-auto w-full flex-col bg-contain bg-left bg-no-repeat md:h-[42.5rem] md:flex-row md:bg-vetor2">
          <div className="mt-16 w-full px-4 md:ml-10 md:mt-32 md:w-[45rem]">
            ...
            <button className="ml-6 mt-8 w-[18.75rem] rounded-xl border-2 border-azul-900 p-2 font-yanone text-lg font-medium text-azul-900 md:p-3 md:text-[2.1875rem]">
              Crie seu personagem!
            </button>
          </div>
        </div>
        ...
        <div className="absolute top-[54rem] mt-16 flex h-auto w-full flex-col justify-end bg-contain bg-right bg-no-repeat md:top-[54rem] md:h-[43rem] md:flex-row md:bg-vetor3">
          <div className="mt-16 w-full px-4 md:mt-56 md:w-[46.25rem]">
            ...
            <button className="mb-4 ml-5 mt-8 w-[18.75rem] rounded-xl border-2 border-azul-900 p-2 font-yanone text-lg font-medium text-azul-900 md:ml-24 md:p-3 md:text-[2.1875rem]">
              Assista agora!
            </button>
          </div>
        </div>
